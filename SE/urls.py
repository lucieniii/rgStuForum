...
urlpatterns = [
    ...
    path('AllList/<int:id>/', view_space.all_lists, name="AllLists"),
    ...
    path('post_update/<str:id>/', view_forum.post_update, name='post_update'),
    path('search/', view_forum.post_list, name='search'),
    path('register/', view_login.register, name='register'),
    path('post_safe_delete/<str:id>/', view_forum.post_safe_delete, name='post_safe_delete'),
    path('comment_safe_delete/<str:id>/', view_forum.comment_safe_delete, name='comment_safe_delete'),
    path('logout/', view_login.logout, name='logout'),
    path('base/', view_forum.base, name='base'),
    path('space/<str:id>/', view_space.space, name='space'),
    path('settings/<str:id>', view_space.settings, name='settings'),
    path('FriendList/<str:id>', view_space.friendList, name='FriendList'),
    path('LetterList/<str:id>', view_space.letterList, name='LetterList'),
    path('Letter/<str:id>', view_space.letter, name='Letter'),
    path('BlackList/<str:id>', view_space.blackList, name='BlackList'),
    path('BlogList/<str:id>', view_space.BlogList, name='BlogList'),
    path('myInfo/<str:id>', view_space.myInfo, name='myInfo'),
